			...
			<div class="login-wrapper">
				<div class="box">
                                    ...
                                    <div class="content-wrap">						
                                                        ...
                                                        <h4 style="font-size: 21px">Télécharger vos informations :</h4>
                                                        <form method="post" action="index.php?uc=droit&action=json">                                                                                                                                                                            
                                                            <br/>
                                                            <input type="submit" class="btn btn-primary signup" href='index.php?uc=droit&action=json&id=<?php $_SESSION['id'];?>' value="Télécharger mes informations"/><br/>
